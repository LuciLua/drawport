    ...
    return (
        ...
        before:bg-[#96969611] before:w-[50em] before:h-[50em] before:absolute before:top-[-200px] before:left-[-400px] before:content-['a'] z-[1] before:rounded-[60%]">
            <div className="max-w-[250px] flex flex-col">
                ...
                <h1 className="text-[60px] font-[600] text-[#424242] flex mb-[20px]">Luci</h1>
            ...
            <div className="absolute flex flex-col gap-[30px] left-[20px] z-[2]">
                ...
                <a className="text-[#121212] text-[20px] opacity-[0.8] transition-[0.3s] hover:opacity-[1] hover:scale-[1.1] hover:transition-[0.3s]" href="mailto:luci.lua81@gmail.com?subject=LuciLua | Cinema Portfólio&cc=luci.lua81@gmail.com&body=Olá, sou _____. Vim através do seu portfólio de artes e gostaria de entrar em contato com você!">
                    <AiOutlineMail />
                </a>
                <Link href={'https://github.com/lucilua'} className="text-[#121212] text-[20px] opacity-[0.8] transition-[0.3s] hover:opacity-[1] hover:scale-[1.1] hover:transition-[0.3s]">
                    <FiGithub />
                </Link>
                <Link href={'https://twitter.com/L4dev'} className="text-[#121212] text-[20px] opacity-[0.8] transition-[0.3s] hover:opacity-[1] hover:scale-[1.1] hover:transition-[0.3s]">
                    <FiTwitter />
                </Link>
                <Link href={'https://www.youtube.com/@lucia8161'} className="text-[#121212] text-[20px] opacity-[0.8] transition-[0.3s] hover:opacity-[1] hover:scale-[1.1] hover:transition-[0.3s]">
                    <SlSocialYoutube />
                </Link>
            </div >
