...
function Menu() {
    return (
        <div className="w-full h-heightMenu justify-center overflow-x-hidden flex z-[20] relative dark:text-[#fff]">
            <div className="w-full h-full max-w-max-w-content flex items-center justify-between py-0 px-[30px]">
                ...
                <ul className="gap-[50px] dark:text-[#fff] text-[#000] hidden lg:flex">
                ...
                <ul className="flex gap-3">
                    <li className="w-[30px] h-[30px] shadow-lg rounded-lg bg-slate-50 text-slate-500 font-normal flex justify-center items-center cursor-pointer hover:bg-[#5a5b65] hover:text-[#fff]">
                        <AiOutlineMenu />
                    </li>
